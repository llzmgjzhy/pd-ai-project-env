...
def main(args):
    ...
    info_list_prpd = read_us_data_info(table_name="us_waveform_prps_info")
    ...
    for i in range(len(info_list_prpd)):
        filename = info_list_prpd["FILE_NAME"][i]
        staname = info_list_prpd["STATION_NAME"][i]

        filenames = get_filenames(info_list_prpd["FILE_NAME"], i)
